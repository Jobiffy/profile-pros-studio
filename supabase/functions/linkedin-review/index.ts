...
serve(async (req) => {
  ...
  try {
    ...
    if (!profileText || profileText.trim().length < 50) {
      return new Response(
        JSON.stringify({ error: "Please provide your full LinkedIn profile text (at least 50 characters)." }),
            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  overallScore: {
                    type: "number",
                    description: "Overall profile score out of 100",
                  },
                  projectedOverallScore: {
                    type: "number",
                    description: "Projected overall score after implementing all suggestions, out of 100",
                  },
                  summary: {
                    type: "string",
                    description: "A brief 2-3 sentence executive summary of the profile's strengths and weaknesses",
                  },
                  sections: {
                    type: "array",
                    items: {
                      ...
                      properties: {
                        name: {
                          type: "string",
                          description: "Section name (e.g. Headline, About/Summary, Experience, Skills, Projects, Education, Profile Completeness, Keywords/ATS Relevance, Impact & Achievements)",
                        },
                        ...
                        issues: {
                          type: "array",
                          items: { type: "string" },
                          description: "List of specific issues or gaps identified",
                        },
                        suggestions: {
                          type: "array",
                          items: { type: "string" },
                  ...
                  topStrengths: {
                    type: "array",
                    items: { type: "string" },
                    description: "Top 3-5 strengths of the profile",
                  },
                  criticalImprovements: {
                    type: "array",
                    items: { type: "string" },
                    description: "Top 3-5 most critical improvements needed",
                  },
                },
                required: ["overallScore", "projectedOverallScore", "summary", "sections", "topStrengths", "criticalImprovements"],
                additionalProperties: false,
              },
            },
          },
